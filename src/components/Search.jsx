...
const Search = (props) => {
    ...
    return (
        <>
            <div className="bg-white flex gap-4 py-4 px-6 rounded-[48px] absolute items-center z-20 mt-[30px]">
                ...
                <input type="text" placeholder="Search" className="text-black text-[32px]"/>
            </div>
        </>
    )
}
